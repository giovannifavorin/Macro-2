//
//  ActOfContritionSecondViewController.swift
//  Macro02
//
...
class ActOfContritionSecondViewController: UIViewController {
    ...
    private func setupDescriptionLabel() {
        ...
        “Meu Deus, arrependo-me de todo o coração de todos os meus pecados e detesto-os, porque ao pecar, não só mereço as penas que causam, mas principalmente porque te ofendo a Ti, sumo Bem e digno de amor acima de todas as coisas.\nPor isso proponho firmemente, com a ajuda da Tua graça, daqui em diante não voltar a pecar e fugir de toda a ocasião de pecado.\nAmém.”
        """, attributes: [
    ...
    private func setupButtons() {
        ...
        nextBt.setTitle("Me arrependo", for: .normal)
    ...
    @objc private func goForward() {
        coordinator?.handleNavigation(.readyToConfess, vc: self)
    }
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            // Botão "Next"
            nextBt.widthAnchor.constraint(equalToConstant: view.bounds.width * 0.35),
