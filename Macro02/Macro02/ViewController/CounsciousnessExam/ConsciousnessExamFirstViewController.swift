//
//  ConsciousnessExamFirstViewController.swift
//  Macro02
//
...
class ConsciousnessExamFirstViewController: UIViewController {
    ...
    @objc private func goForward() {
        coordinator?.handleNavigation(.consciousnessExamSecond)
    }
...
class ProgressBarUI: UIView {
    ...
    private let barHeightMultiplier: CGFloat = 1.0
    ...
    private func setupBars() {
        // Inicializando o UIStackView globalmente
        ...
        for i in 0..<barCount {
            let bar = UIView()
            bar.backgroundColor = i <= index ? .black : .lightGray
