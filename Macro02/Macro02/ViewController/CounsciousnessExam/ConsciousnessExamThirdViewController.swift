//
//  ConsciousnessExamThirdViewController.swift
//  Macro02
//
...
class ConsciousnessExamThirdViewController: UIViewController, UITextFieldDelegate {
    ...
    @objc private func goForward() {
        coordinator?.handleNavigation(.consciousnessExamFourth)
    }
...
extension ConsciousnessExamThirdViewController: SinViewModelDelegate {
    
    func didUpdateSavedSins(_ savedSins: [Sin]) {
        commandments = viewModel.getGroupedSinsForFourthToSeventhCommandment()
...
extension ConsciousnessExamThirdViewController: UITableViewDelegate, UITableViewDataSource {
...
// MARK: - Keyboard
extension ConsciousnessExamThirdViewController {
